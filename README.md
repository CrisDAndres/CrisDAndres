...
- 🧠 [Convolutional Neural Network project](https://github.com/CrisDAndres/Redes_Neuronales_Convolucionales): Project focused on convolutional neural networks (CNNs) used for image recognition.
